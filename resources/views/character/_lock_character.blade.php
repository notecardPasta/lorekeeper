...
@if (!$character->is_locked)
    <p>Locking a character will extend its cooldown by <b> {{ $lockcooldown }} </b> days, during which you will not be able to trade, gift, or sell the character. Your character will not appear in masterlist searches for trade/sellable characters.
        Your character's trade and sell status will remain preserved.</p>
