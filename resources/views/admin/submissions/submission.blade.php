...
@section('admin-content')
                ...
                <tr class="character-reward-row">
                    ...
                    @else
                        <td class="lootDivs">
                            ...
                            {!! Form::select('character_rewardable_id[]', $tables, 0, ['class' => 'form-control character-table-id', 'placeholder' => 'Select Loot Table']) !!}
                        </td>
                    @endif
    ...
    @else
        ...
        @include('home._submission_content', ['submission' => $submission, 'rewardRecipient' => $rewardRecipient ?? null])
    @endif
